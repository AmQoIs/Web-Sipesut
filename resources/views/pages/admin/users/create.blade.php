...
@section('content')
    ...
    <div class="flex flex-col justify-center items-center my-5">
        ...
        <div class="flex justify-center w-full">
            ...
            <form action="/admin/users/create" id="add-user" method="POST" class="flex flex-col gap-4 w-full max-w-xl px-8"
                ...
                <div>
                    ...
                    <x-text-input id="email" class="block mt-1 w-full" type="text" name="email" :value="old('email')"
                        required autofocus placeholder="TNI@gmail.com" pattern="^\S+@\S+$" />
                ...
                <!--password Lama-->
                <div>
                    <x-input-label class="block my-2 text-sm text-gray-600" for="old" :value="__('Password')" />
                ...
                <!--Password baru-->
                <div>
                    <x-input-label class="block my-2 text-sm text-gray-600" for="new" :value="__('Konfirmasi Password')" />
    ...
    <script>
        function send() {
            Swal.fire({
                title: "Anda yakin untuk menambahkan akun?",
                icon: "warning",
