<x-guest-layout>
    <div class="mt-32 mb-12">
        ...
        <div class="flex justify-center w-full mb-8">
            <form action="{{ route('anggota.users.update', ['id' => $user->id]) }}" id="edit-profile" method="POST"
                ...
                <div>
                    ...
                    <input id="nama"
                        ...
                        type="text" name="nama" required autofocus placeholder="Masukkan Nama Baru"
                        value="{{ $user->nama }}" />
        ...
        <div class="flex justify-center w-full">
            <form action="{{ route('anggota.users.change-password', ['id' => $user->id]) }}" id="change-password"
                ...
                <div>
                    ...
                    <div class="relative" x-data="{ show: false }">
                        ...
                        <button type="button" @click="show = !show"
                            class="absolute top-2 right-5 w-[1.5em] text-primary">
