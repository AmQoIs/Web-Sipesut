 ...
 >
   ...
   <div>
     ...
     <ul class="mb-6 flex flex-col gap-1.5">
       ...
       <li>
        <a
            class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-[#e96e53] dark:hover:bg-meta-4"
            href="{{ route('admin') }}"
            @click="selected = 'Dashboard'"
            {{-- @click.prevent="selected = (selected === 'Dashboard' ? '':'Dashboard')" --}}
            :class="{ 'bg-[#e96e53] dark:bg-meta-4': (selected === 'Dashboard' || '{{ request()->routeIs('admin') }}') }"
        >
           <svg
             class="fill-current"
             width="18"
       ...
       <li>
          <a
              ...
              :class="{ 'bg-[#e96e53] dark:bg-meta-4': (selected === 'Profile' && page === 'profile'), 'bg-primary': (selected === 'Profile' && page !== 'profile') }"
          >
              <svg
                  class="fill-current"
                  width="18"
       ...
       <li>
         <a
           class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-[#e96e53] dark:hover:bg-meta-4"
           href="#"
           @click.prevent="selected = (selected === 'Surats' ? '':'Surats')"
           :class="{ 'bg-[#e96e53] dark:bg-meta-4': (selected === 'Surats') || (page === 'semua' || page === 'belumDicek') }"
         >
         <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
          <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
           ...
           <svg
            class="absolute right-4 top-1/2 -translate-y-1/2 fill-current"
            :class="{ 'rotate-180': (selected === 'Surats') }"
            width="20"
            height="20"
            viewBox="0 0 20 20"
            fill="none"
       ...
       <div
          ...
          :class="(selected === 'Surats') ? 'block' :'hidden'"
        >
          <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
            <li>
              <a
                  class="group relative flex items-center gap-2.5 px-4 font-medium text-gray-300 duration-300 ease-in-out hover:text-white"
                  href="{{ route('admin.surat.index') }}"
                  :class="{ 'text-white border-l-4 border-primary': '{{ Route::currentRouteName() }}' === 'admin.surat.index' }"
            ...
            <li>
              <a
                class="group relative flex items-center gap-2.5 px-4 font-medium text-gray-300 duration-300 ease-in-out hover:text-white"
                href="{{ route('admin.surat.belum_dicek') }}"
                :class="{ 'text-white border-l-4 border-primary': '{{ Route::currentRouteName() }}' === 'admin.surat.belum_dicek' }"
                >Belum dicek</a
              >
            </li>
            ...
            <li>
              <a
                class="group relative flex items-center gap-2.5 px-4 font-medium text-gray-300 duration-300 ease-in-out hover:text-white"
                href="{{ route('admin.surat.diterima') }}"
                :class="{ 'text-white border-l-4 border-primary': '{{ Route::currentRouteName() }}' === 'admin.surat.diterima' }"
                >Diterima</a
              >
            </li>
            <li>
              <a
                class="group relative flex items-center gap-2.5 px-4 font-medium text-gray-300 duration-300 ease-in-out hover:text-white"
                href="{{ route('admin.surat.ditolak') }}"
                :class="{ 'text-white border-l-4 border-primary': '{{ Route::currentRouteName() }}' === 'admin.surat.ditolak' }"
                >Ditolak</a
              >
            </li>
            <li>
              <a
                class="group relative flex items-center gap-2.5 px-4 font-medium text-gray-300 duration-300 ease-in-out hover:text-white"
                href="{{ route('admin.surat.revisi') }}"
                :class="{ 'text-white border-l-4 border-primary': '{{ Route::currentRouteName() }}' === 'admin.surat.revisi' }"
                >Revisi</a
              >
            </li>
          </ul>
