...
>
 ...
 >
   <div class="flex items-center gap-2 sm:gap-4 lg:hidden">
     ...
     <button
       class="z-99999 block rounded-sm border border-stroke bg-primary p-1.5 shadow-sm"
   ...
   <div class="hidden sm:block">
    <p class="font-bold">Sistem Informasi Pengelolaan Surat <span class="block font-normal">Inspektorat Jenderal TNI Republik
      Indonesia</span></p>
   ...
   <div class="flex items-center gap-3 2xsm:gap-7">
     ...
     >
       ...
       >
         ...
         <span class="p-2 rounded-full bg-secondary text-white items-center">
