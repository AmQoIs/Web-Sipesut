    ...
    <div class="p-6">
        ...
        <div class="flex items-center mb-4 border-b pb-2">
            <div class="flex items-center ">
                ...
                <div class="ml-2">
                    <p class="block text-gray-400 mb-0">Judul Surat <span class="block text-black font-bold">
                            {{ $surat->judul }}</span></p>
        ...
        <div class="flex items-center justify-between mb-4 border-b pb-2">
            <div class="flex items-center max-w-[140px]">
                ...
                <div class="ml-2">
                    <p class="block text-gray-400 mb-0">Diajukan oleh <span class="block text-black font-bold">
                            {{ $surat->dari }}</span></p>
        ...
        <div class="flex items-center mb-4 border-b pb-2">
            ...
            <div class="ml-2">
                <p class="block text-gray-400 mb-0">Ditujukan Kepada <span class="block text-black font-bold">
                        {{ $surat->kepada }}</span></p>
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center">
                ...
                <div class="ml-2">
                    <p class="block text-gray-400">Status <span
                            class="block mt-2 rounded-full bg-opacity-10 @if ($surat->status == 'BELUM_DICEK') bg-warning text-warning @elseif($surat->status == 'DITOLAK') bg-danger text-danger @elseif($surat->status == 'REVISI') bg-secondary text-secondary @elseif($surat->status == 'DITERIMA') bg-success text-success @endif px-3 py-1 text-sm font-medium">
                            {{ str_replace('_', ' ', $surat->status) }}</span></p>
                </div>
            ...
            <div class="flex items-center">
                ...
                <div class="ml-2">
                    ...
                    <p class="block text-gray-400 mb-0">
                        File
                        <span class="flex">
                            <a href="{{ route('admin.surat.lihat', ['id' => $surat->id]) }}"
        ...
        <div class="mt-4">
            <p class="blinking-text text-center text-sm">
                Setelah mengunduh, Anda bisa pergi ke tab <span class="font-bold">Kelola Surat</span> untuk
                mengubah
                status surat.
            </p>
        </div>
