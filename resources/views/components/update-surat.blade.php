<div class="flex flex-col justify-center items-center mb-12">
    <h1 class="text-3xl font-bold">Ubah Surat</h1>
    <div class="flex justify-center w-full">

        <form action="{{ route('admin.surat.edit-post', ['id' => $surat->id]) }}" id="edit-surat" method="POST"
                    ...
                    .then(response => response.json()).then(data => {
                        if (data.success) {
                            Swal.fire({
                                ...
                                window.location.href = `/admin/surat/${data.id}`;
                            });
                        } else {
                            Swal.fire({
                                title: "Gagal!",
